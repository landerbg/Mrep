...
$.widget( "sustainablepace.mobipick", $.mobile.widget, {
	...
	open: function( evt ) {
		...
		if( !this._isXDate( date ) ) {
            ...
            var date = date = new XDate();//ТОВА СЪМ СИ ГО ПРОМЕНИЛ АЗ !!!!!!!!!! - оригинално е горното.Така не взима датата от инпута защото не може да взима дата във формат mm.dd.yyyy
